    ...
    <div class="col-12 mt-3 mb-3">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="file_management.php" method="POST">
                    <div class="col-md-3">
                        <select name="folder">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php
                    // Define where to find the thumbnails
                    $thumb_dir = 'thumbnails/';
                    $pdfImage = 'images/PDFimage.png';

                    // Get all files and associated metadata from the database based on the selected folder and on the user
                    $dbConn = db_connect();
                    $query = "SELECT original_name, file_name, mime_type, created_at, created_by FROM files WHERE directory = $1 AND created_by = $2";
                    $result = pg_query_params($dbConn, $query, array($selectedFolder, $email));
